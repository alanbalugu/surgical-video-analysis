...
def convert_frame_object_to_xml(frame_obj, destination, prefix=''):
    ...
    myfile = open(os.path.join(destination, re.sub('\\.jpeg | \\.jpg', '.xml', frame_file_name)), "wb")
...
def main():
    ...
    FRAME_JPG_PATH = os.path.join(BASE_FILE_PATH, "JPEGImages")
    ...
    for unique_frames in ground_truth.groupby(["trial_frame"]):
        ...
        img_width = trial_dict[unique_frames[0][0:-20]][0]
        img_height = trial_dict[unique_frames[0][0:-20]][1]
